...
function setup_custom_posts() { 
	...
	register_post_type( 'dynamic_content', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		// let's now add all the options for this post type
		array( 'labels' => array(
			'name' => __( 'Dynamic Content', 'ReadWriteDiscover' ), /* This is the Title of the Group */
			'singular_name' => __( 'Snippet', 'ReadWriteDiscover' ), /* This is the individual type */
			'all_items' => __( 'All Content', 'ReadWriteDiscover' ), /* the all items menu item */			//'add_new' => __( 'Add New', 'bonestheme' ), /* The add new menu item */
			...
			'rewrite'	=> array( 'slug' => 'dynamic', 'with_front' => false ), /* you can specify its url slug */
			'capability_type' => 'post',
			'hierarchical' => false,
	...
	//register_taxonomy_for_object_type( 'category', 'dynamic_content' );
	/* this adds your post tags to your custom post type */
	register_taxonomy_for_object_type( 'post_tag', 'dynamic_content' );
	...
	*/
	...
	// 	array('dynamic_content'), /* if you change the name of register_post_type( 'custom_type', then you have to change this */
